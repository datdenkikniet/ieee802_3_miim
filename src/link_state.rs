...
use crate::{
    registers::{
        auto_negotiation::*, leader_follower::*, Duplex as DuplexConfig, DuplexMode as Duplex, *,
    },
    LinkSpeed, LinkState,
};
...
mod test {
    ...
    use crate::{
        registers::{
            ...
            BasicControl, BasicControlLinkConfig, BasicStatus, Duplex as DuplexConfig,
            DuplexMode as Duplex,
        },
